...
$(".icon-align-left").click(function() {
    if(!$(this).hasClass("selected")) {
        updateCell("justify-content","end",true);
...
$(".icon-align-center").click(function() {
    if(!$(this).hasClass("selected")) {
        updateCell("justify-content","center",true);
...
$(".icon-align-right").click(function() {
    if(!$(this).hasClass("selected")) {
        updateCell("justify-content","flex-end",true);
        ...
        if($(".sheet-options-model").length == 0){
            ...
            $(".sheet-delete").click(function(){
                if(Object.keys(cellData).length > 1){
                    ...
                    alert("Sorry! there is only one sheet Present. So it's not possible to delete.");
                }
            })
        }
